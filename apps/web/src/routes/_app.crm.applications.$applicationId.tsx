...
import { useArchiveApplication, useUpdateApplicationStatus } from '../features/crm/hooks'
import { APPLICATION_STATUSES, type ApplicationOut } from '../features/crm/api'
import { ApplicationStatusBadge } from '../features/crm/components/ApplicationCard'
...
function ApplicationDetailPage() {
  ...
  const appQuery = useQuery({
    ...
    queryFn: () => api<ApplicationOut>(`/applications/${applicationId}`),
  })
